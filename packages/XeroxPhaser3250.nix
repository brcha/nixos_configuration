...
#   printing = {
#     enable = true;
#     drivers = [ pkgs.xerox_p3250_7_6_09 ];
#   };
#   (more stuff)
# }
# (This advice was tested on the 15th February, 2020.)

{ stdenv, fetchurl, cups, libusb1, lib, ... }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://download.support.xerox.com/pub/drivers/3250/drivers/linux/ar/p3250.tar.gz";
  ...
  meta = with lib; {
    description =
      "Xerox's Linux printing driver for Phaser P3250; includes binaries without source code";
